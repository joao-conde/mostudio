...
const translations = {
  en: {
    ...
    'booking.subtitle': 'Ready to look your best? Let\'s schedule your makeup session.',
    'booking.name': 'Name',
    'booking.email': 'Email',
    'booking.phone': 'Phone',
    ...
    'booking.services': 'View Services',
    'booking.success': 'Thank you {name}! We\'ll be in touch soon.',
    'booking.error': 'Failed to send message. Please try again.',
    'booking.placeholder.name': 'Your full name',
    'booking.placeholder.email': 'your@email.com',
    'booking.placeholder.phone': '+1 (555) 000-0000',
    'booking.placeholder.notes': 'Any special requests or details...',
  ...
  pt: {
    ...
    // Booking
    'booking.title': 'Reserve Sua Sessão',
    'booking.subtitle': 'Pronta para ficar deslumbrante? Vamos agendar sua sessão de maquiagem.',
    'booking.name': 'Nome',
    'booking.email': 'Email',
    'booking.phone': 'Telefone',
    'booking.notes': 'Notas Adicionais',
    'booking.submit': 'Reservar Agora',
    'booking.sending': 'Enviando...',
    'booking.services': 'Ver Serviços',
    'booking.success': 'Obrigada {name}! Entraremos em contato em breve.',
    'booking.error': 'Falha ao enviar mensagem. Tente novamente.',
    'booking.placeholder.name': 'Seu nome completo',
    'booking.placeholder.email': 'seu@email.com',
    'booking.placeholder.phone': '+351 900 000 000',
    'booking.placeholder.notes': 'Pedidos especiais ou detalhes...',
